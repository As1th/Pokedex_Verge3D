...
var Bulbasaur_data, Ivysaur_data, species_list, current_species_model, current_species_id, mouse_window_y, count, current_species_data, mouse_window_x, camera_s_, cam_y, hover_drag, set_cam, cam_x, cam_start_pos;
...
function increment_species() {
  ...
  if (current_species_id >= species_list.length - 1) {
...
Bulbasaur_data = ['Bulbasaur', ('This is' + '\n' +
'multi-line' + '\n' +
'text'), 'Bulbasaur'];
Ivysaur_data = ['Ivysaur', ('This is' + '\n' +
'multi-line' + '\n' +
'text2'), 'Ivysaur'];
species_list = [Bulbasaur_data, Ivysaur_data, null];
current_species_id = 0;
current_species_data = species_list[current_species_id];
current_species_model = current_species_data[2];
...
registerOnClick(['ALL_OBJECTS'], false, false, [0,1,2], function() {}, function() {});
