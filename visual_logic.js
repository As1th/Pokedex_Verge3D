...
var species_list, i, current_species_id, current_species_model, current_species_data, mouse_window_y, count, mouse_window_x, camera_s_, cam_y, hover_drag, set_cam, cam_x, current_species_name, cam_start_pos;
...
function decrement_species() {
  ...
  animateParam(1, 0, 0.2, 'Cubic', 'Out', 0, false, '{gk17+|-0ODuKX0tov3j',
    ...
    setObjTransform(current_species_model, false, 'scale', [0, 0, 0], false);
    setObjTransform(current_species_model, false, 'position', [0, 0, 0], false);

    animateParam(0, 1, 0.2, 'Linear', 'Out', 0, false, 'A4SsuQt1Fe*x0ycK1oRp',
        function() {
      setObjTransform(current_species_model, false, 'scale', [_pGlob.animateParamUpdate || 0, _pGlob.animateParamUpdate || 0, _pGlob.animateParamUpdate || 0], false);
    },
        function() {});
...
function increment_species() {
  ...
  animateParam(1, 0, 0.2, 'Cubic', 'Out', 0, false, 'pL:61Bmp^`]RdiL9jEL_',
    ...
    animateParam(0, 1, 0.2, 'Linear', 'Out', 0, false, 'O^X+U2}vX?oxLCmOxbCw',
        function() {
      setObjTransform(current_species_model, false, 'scale', [_pGlob.animateParamUpdate || 0, _pGlob.animateParamUpdate || 0, _pGlob.animateParamUpdate || 0], false);
    },
        function() {});
...
species_list = [['Bulbasaur', ('This is' + '\n' +
'multi-line' + '\n' +
'text'), 'Bulbasaur'], ['Ivysaur', ('This is' + '\n' +
'multi-line' + '\n' +
'text2'), 'Ivysaur'], ['Venusaur', ('This is' + '\n' +
'multi-line' + '\n' +
'text3'), 'Venusaur'], ['Charmander', ('This is' + '\n' +
'multi-line' + '\n' +
'text3'), 'Charmander'], ['Charmeleon', ('This is' + '\n' +
'multi-line' + '\n' +
'text3'), 'Charmeleon'], ['Charizard', ('This is' + '\n' +
'multi-line' + '\n' +
'text3'), 'Charizard'], ['Squirtle', ('This is' + '\n' +
'multi-line' + '\n' +
'text3'), 'Squirtle'], ['Wartortle', ('This is' + '\n' +
'multi-line' + '\n' +
'text3'), 'Wartortle'], ['Blastoise', ('This is' + '\n' +
'multi-line' + '\n' +
'text3'), 'Blastoise']];
