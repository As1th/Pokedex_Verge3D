...
setHTMLElemStyle('backgroundColor', '#91CCE5', ['BODY'], false);
...
var current_species_id, Bulbasaur_data, Rhyperior_data, current_species_model, species_list, mouse_window_y, count, mouse_window_x, camera_s_, cam_y, hover_drag, set_cam, cam_x, current_species_data, cam_start_pos;
...
'multi-line' + '\n' +
'text'), 'Bulbasaur'];
Rhyperior_data = ['Rhyperior', ('This is' + '\n' +
'multi-line' + '\n' +
'text2'), 'Rhyperior'];
species_list = [Bulbasaur_data, Rhyperior_data, null];
